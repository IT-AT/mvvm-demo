...
object ATFontUtils {
    ...
    private fun getOpenSansFont(context: Context): Font {
        if (openSans == null) {
            ...
            openSans!!.extraBold =
                Typeface.createFromAsset(context.assets, "fonts/OpenSans-ExtraBold.ttf")
            openSans!!.semiBold =
                Typeface.createFromAsset(context.assets, "fonts/OpenSans-Semibold.ttf")
            openSans!!.regular =
    ...
    private fun getNunitoSansFont(context: Context): Font {
        if (nunitoSans == null) {
            nunitoSans = Font()
            nunitoSans!!.bold =
                Typeface.createFromAsset(context.assets, "fonts/NunitoSans-Bold.ttf")
            nunitoSans!!.regular =
                Typeface.createFromAsset(context.assets, "fonts/NunitoSans-Regular.ttf")
            nunitoSans!!.semiBold =
                Typeface.createFromAsset(context.assets, "fonts/NunitoSans-SemiBold.ttf")
        }
